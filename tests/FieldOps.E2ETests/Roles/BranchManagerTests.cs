    ...
    public Task BranchManagerEditsPartySchedulesWorkAndCannotReset() => fixture.RunAsync(
        ...
        async (page, errors) =>
        {
            ...
            ScheduleAuditProof audit = await fixture.QuerySingleAsync(
                "SELECT \"ActorUserId\", \"BranchId\", \"Outcome\", \"ChangeSummary\" FROM \"AuditEntries\" WHERE \"AggregateId\" = '30000000-0000-4000-8000-000000000001' AND \"Action\" = 'ScheduledAndAssigned'",
